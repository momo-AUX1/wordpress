...
if (!$user_info) {
  echo '<div class="profile-container"><p style="color:#A00;">User not found.</p></div>';
  get_footer();
  exit;
}
...
<div class="profile-container">
  <img class="user-avatar" src="<?php echo esc_url($avatar_url); ?>" alt="User Avatar">

  <div class="profile-username"><?php echo esc_html($display_name); ?></div>

  <h2 style="font-size:1.2rem;color:#880E4F;margin-bottom:1rem;">Uploaded Apps</h2>
  ...
  <?php else: ?>
    <p class="no-apps"><?php echo ($user_id == get_current_user_id()) ? 'You haven’t uploaded any apps yet.' : 'This user has no uploaded apps.'; ?></p>
  <?php endif; ?>
</div>
